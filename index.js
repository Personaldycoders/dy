...
if(usePairingCode && !ehz.authState.creds.registered) {
		const phoneNumber = await question('MASUKKAN NOMOR DENGAN AWALAN 62 UNTUK MENDAPATKAN PAIRING CODE || SC BY DY_CODERS\n');
...
require('./dy.js')(ehz, m, chatUpdate,store)
...
sourceUrl: "https://whatsapp.com/channel/0029VaBqOJmLdQeUw9URW60k",
mediaType: 1,
...
mediaType: 1,
thumbnailUrl: ppuser,
sourceUrl: "https://instagram.com/xyy_dy_coders",
renderLargerThumbnail: true
}
}
 ...
 //=================================================//
   ehz.sendImageAsSticker = async (jid, media, m, options = {}) => {
    ...
    let jancok = new Sticker(media, {
        pack:"dy_net", // The pack name
        author:"Created By dy_coderS",// The author name
  ...
  title:"dy_net",body: `${textT}`,previewType:"PHOTO",thumbnail: fs.readFileSync('./media/thumb.jpeg'),
  sourceUrl:'https://whatsapp.com/channel/0029VaBqOJmLdQeUw9URW60k'																																
...
connectToWhatsApp();
  ...
  ehz.sendMessage('6285719898124' + "@s.whatsapp.net", { text: `Hai Sayang Aku On Kembali 
